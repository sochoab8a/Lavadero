                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<cantidadFotos;i++){
                                ...
                                String urlFoto="https://peritoneal-teeth.000webhostapp.com/camera/FotosVehiculos/"+jsonObject.getString("cedula")+"/foto"+i+""+".jpg";
                            ...
                            Toast.makeText(Terminar.this, ""+arch, Toast.LENGTH_SHORT).show();
